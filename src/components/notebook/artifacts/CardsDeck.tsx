    ...
    <div className="space-y-3">
      ...
      >
        {cards.map((c, i) => (
          <article
            key={c.title + i}
            className={`group relative flex h-64 w-[260px] shrink-0 snap-center flex-col justify-between overflow-hidden rounded-2xl bg-gradient-to-br p-4 text-primary-foreground shadow-xl transition-all duration-500 hover:-translate-y-1.5 hover:shadow-2xl ${
