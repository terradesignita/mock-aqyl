...
export const kk: Dictionary = {
  ...
  newCase: {
    ...
    progressNote: "Кейс тізімде бірден пайда болады, талдау фонда жүреді.",
    pendingSummary:
  ...
  /** Файлдарды өңдеу күйінің виджеті — 41-сурет. */
  ingestWidget: {
    titleRunning: (n: number) => `${n} файл өңделуде`,
    titleDone: (n: number) => `${n} файл дайын`,
    titleError: (n: number) => `${n} файл қабылданбады`,
    titleMixed: (done: number, failed: number) => `${done} дайын · ${failed} қабылданбады`,
    collapse: "Өңдеу күйін жию",
    expand: "Өңдеу күйін ашу",
    close: "Аяқталғандарды алу",
    dismissOne: "Тізімнен алу",
    done: "Талданып, кейске қосылды",
    open: "Ашу",
    rejected: (format: string) => `${format} — формат қолданылмайды`,
    pickAnother: "Басқа файл таңдау",
  },

  /** Интерфейстегі 18 «?» батырмасының орнына бір анықтама нүктесі (есеп §6). */
  help: {
    open: "Бұл қалай жұмыс істейді",
    title: "Бұл қалай жұмыс істейді",
    subtitle:
      "Платформа сүйенетін жеті ұғым. Мұнда экрандағы жазудың өзі түсіндіре алмағаны жинақталған.",
    caseTitle: "Кейс және материал",
    caseBody:
      "Кейс — бір тақырып бойынша қалта: ішіне материалдар салынады (есеп, презентация, жазба, мақала). Материал — кейс ішіндегі бір құжат. Кейс «Жаңа кейс» батырмасымен файлдан жасалады: атауды платформа файл атынан емес, мазмұнынан алады.",
    sourcesTitle: "Дереккөздер және контекст",
    sourcesBody:
      "Ассистент сол панельде белгіленген дереккөздер бойынша ғана жауап береді. Белгіні алып тастау материалды контекстен шығарады — жауап өзгереді. Ештеңе белгіленбесе, ассистент ойдан құрмай, жауап беруден бас тартады. Жауаптағы [1], [2] сілтемелері нақты дәйексөзге апарады.",
    advisorTitle: "Іздеу және AI-кеңесші",
    advisorBody:
      "Іздеу кейстер бойынша жүреді: атаулар, сипаттамалар және тегтер. AI-кеңесші шешім қабылдау қажет болғанда керек: нақтылаушы сұрақтар қояды, жағдайды қалай түсінгенін көрсетеді және нұсқалармен, шарттармен, тәуекелдермен ұсыныс береді.",
    evidenceTitle: "Дәлелділік және қолданылымдылық",
    evidenceBody:
      "Дәлелділік — тұжырым неге сүйенеді: жоғары — бірнеше тәуелсіз дереккөз; орташа — бір сенімді дереккөз; төмен — жанама деректер; дерек жеткіліксіз — кеңесші ұсыныстан бас тартады. Қолданылымдылық — ұқсас кейстің сіздің жағдайыңызға қаншалықты жақын екені: жоғары, ішінара немесе әлсіз ұқсастық.",
    artifactsTitle: "Артефактілер",
    artifactsBody:
      "Белгіленген дереккөздер негізіндегі дайын форматтар: тест, презентация, есеп, карточкалар, подкаст, инфографика. Тақтадағы «⋮» — қайта жасау, толық экранда ашу немесе жүктеу. Жіберер алдында цифрлар мен дәйексөздерді түпнұсқамен салыстырыңыз.",
    councilTitle: "Консилиум",
    councilBody:
      "Сіздің міндетіңізді бірден бірнеше AI-персонамен топтық талқылау: бір пікірдің орнына пікір қақтығысы мен әртүрлі көзқарас аласыз. Персоналар — жария танымал тәсілдердің цифрлық үлгілері, нақты адамдар емес және олардың жеке көзқарасы емес. Қатысушылар — бірден үшке дейін.",
    privacyTitle: "Жабық және ортақ кейстер",
    privacyBody:
      "Жабық кейс тек сізге көрінеді және ортақ іздеуге қатыспайды. Ортақ кейс барлық қызметкерге қолжетімді. Бұл кейс карточкасының өзінде ауыстырылады.",
    shortcutsTitle: "Пернелер тіркесімі",
    keySlash: "/",
    keySlashWhat: "курсорды іздеуге",
    keyEsc: "Esc",
    keyEscWhat: "терезені жабу",
    keyF: "F",
    keyFWhat: "артефакт толық экранда",
  },
